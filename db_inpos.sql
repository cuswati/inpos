...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2019 at 09:24 AM
...
CREATE TABLE `pos_member` (
  ...
  `nama_ member` varchar(45) NOT NULL,
...
('1', 'cus', 'cuswatii2004@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Administrator', 1),
('123456', 'kasir', 'kasir@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Kasir', 1),
('181530003', 'Cuswati', 'cuswati@gmail.com', '0192023a7bbd73250516f069df18b500', 'Administrator', 1);
...
ALTER TABLE `pos_barangmasuk`
  ADD PRIMARY KEY (`no_trans`,`id_user`,`id_supplier`);
